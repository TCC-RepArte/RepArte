...
// Pegar o ID do usuário a ser visualizado (pode ser outro usuário)
$id_usuario = isset($_GET['user_id']) ? $_GET['user_id'] : $_SESSION['id'];
...
try {
    ...
    // Query adaptada - busca favoritos do usuário especificado
    $sql = "SELECT 
                p.id as id_post,
